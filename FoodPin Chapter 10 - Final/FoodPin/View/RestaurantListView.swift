...
struct RestaurantListView: View {
    ...
    var body: some View {
        List {
                ...
                BasicTextImageRow(restaurant: $restaurants[index])
                    .swipeActions(edge: .leading, allowsFullSwipe: false, content: {
                        Button {
                            ...
                            Image(systemName:
                                    restaurants[index].isFavorite ? "heart.slash" : "heart")
                        }
                        .tint(.green)
                        
                        Button {
                            // No está bien referenciado, la acción existe en
            ...
            // No funciona dado que es ignorado cuando se utiliza el modificador swipeActions
//            .onDelete(perform: {
    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Button(action: {
                ...
                HStack {
                    Text(self.restaurant.isFavorite ? "Unmark as Favorite" : "Mark as favorite")
                    Image(systemName: self.restaurant.isFavorite ? "heart.slash" : "heart")
                }
            }
            Button(action: {
                self.showOptions.toggle()
